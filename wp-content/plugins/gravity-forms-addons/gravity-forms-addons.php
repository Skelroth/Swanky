 ...
 <?php 
	...
	public function edit_lead_detail($Form, $lead, $options) {
	    ...
	    ?>
	            ...
	            <?php
	            	...
	            	GFEntryDetail::lead_detail_edit($form_without_products, $lead_without_products);
	...
	*/
	...
	public function get_back_link($options = array()) {
		...
		if($pagenow === 'entry-details.php') { return ''; } // we're in an iframe, people.
...
#			$leads = RGFormsModel::get_leads($form_id);
										...
										switch($input_type){
											...
											case "checkbox" :
												...
												foreach($lead_field_keys as $input_id){
													...
													if(is_numeric($input_id) && absint($input_id) == absint($field_id) && $lead[$input_id] == $field["label"]){
    ...
    public function attr($options, $default = '<span style="font-weight:normal; text-align:center; display:block;">"Gawler LAN Party Directory"</span>') {
